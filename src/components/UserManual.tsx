    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-8 mb-12">
        ...
        >
          ...
          <div>
            <h1 className="text-3xl sm:text-4xl font-bold text-orange-700 dark:text-yellow-100 mb-2">User Manual Guide</h1>
            <p className="text-gray-600 dark:text-gray-300">Complete guide to using the Smart Microgrid Management System</p>
          </div>
        </motion.div>
